/* @ts-self-types="./calculator_engine.d.ts" */
...
export class Calculator {
    ...
    active_op() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.calculator_active_op(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
    ...
    display() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.calculator_display(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     */
    has_entry() {
        const ret = wasm.calculator_has_entry(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @returns {boolean}
     */
    has_memory() {
        const ret = wasm.calculator_has_memory(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @returns {boolean}
     */
    is_deg() {
        const ret = wasm.calculator_is_deg(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @returns {boolean}
     */
    is_error() {
        const ret = wasm.calculator_is_error(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @returns {boolean}
     */
    is_second() {
        const ret = wasm.calculator_is_second(this.__wbg_ptr);
        return ret !== 0;
    }
    constructor() {
    ...
    tape() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.calculator_tape(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./calculator_engine_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('calculator_engine_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
